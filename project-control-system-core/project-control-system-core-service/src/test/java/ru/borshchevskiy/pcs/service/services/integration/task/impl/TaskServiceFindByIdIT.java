...
public class TaskServiceFindByIdIT extends IntegrationTestBase {
    ...
    void teamExists() {
        ...
        TaskDto teamById = taskService.findById(expectedId);
    ...
    void teamDoesntExists() {
        ...
        assertThrows(NotFoundException.class, () -> taskService.findById(expectedId));
    }
