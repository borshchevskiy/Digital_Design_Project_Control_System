...
class TeamMemberServiceFindAllByProjectIdIT extends IntegrationTestBase {
    ...
    public void prepare() {
        ...
        member2.setTeamId(1L);
        member2.setEmployeeId(2L);
        member2.setRole(TeamMemberProjectRole.DEVELOPER);

        teamMemberService.save(member2);
    }
    ...
    void teamsExist() {
        ...
        List<TeamMemberDto> all = teamMemberService.findAllByProjectId(1L);
