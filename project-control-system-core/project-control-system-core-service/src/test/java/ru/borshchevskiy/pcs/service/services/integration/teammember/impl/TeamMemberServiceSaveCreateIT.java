...
class TeamMemberServiceSaveCreateIT extends IntegrationTestBase {
    ...
    void createNewMember() {
        ...
        member2.setEmployeeId(employeeId);
        member2.setRole(TeamMemberProjectRole.DEVELOPER);

        TeamMemberDto actualResult = teamMemberService.save(member2);
    ...
    @Test
    void employeeAlreadyATeammember() {
        ...
        assertThrows(RequestDataValidationException.class, () -> teamMemberService.save(member2));
