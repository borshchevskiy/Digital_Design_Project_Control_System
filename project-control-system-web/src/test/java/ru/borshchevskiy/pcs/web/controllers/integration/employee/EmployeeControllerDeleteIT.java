...
class EmployeeControllerDeleteIT extends IntegrationTestBase {
    ...
    public void delete() throws Exception {
        ...
        dto1.setStatus(EmployeeStatus.DELETED);
    ...
    public void empNotFound() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/employees/" + Long.MIN_VALUE)
                        .with(user(account1))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().is4xxClientError())
                .andExpect(MockMvcResultMatchers.content().contentType("text/plain;charset=UTF-8"))
                .andExpect(MockMvcResultMatchers.content().string("Employee with id=" + Long.MIN_VALUE + " not found!"));
    }


    @Test
    public void tryToDeleteAlreadyDeleted() throws Exception {

        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/employees/3")
                        .with(user(account1))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().is4xxClientError())
                .andExpect(MockMvcResultMatchers.content().contentType("text/plain;charset=UTF-8"))
                .andExpect(MockMvcResultMatchers.content().string("Employee already deleted!"));
    }
