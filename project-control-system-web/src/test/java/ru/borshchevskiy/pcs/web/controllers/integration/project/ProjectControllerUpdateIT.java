...
class ProjectControllerUpdateIT extends IntegrationTestBase {
    ...
    public void notFound() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/projects/" + Long.MIN_VALUE)
                        .with(user(account))
                        .contentType(MediaType.APPLICATION_JSON_VALUE)
                        .content(objectMapper.writeValueAsString(request)))
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string("Project with id=" + request.getId() + " not found!"));
    }

    @Test
    public void tryToChangeCode() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/projects/1")
                ...
                .andExpect(MockMvcResultMatchers.content().contentType("text/plain;charset=UTF-8"))
                .andExpect(MockMvcResultMatchers.content()
                        .string("Project status can't be changed! " +
    ...
    public void codeAlreadyExists() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/projects/1")
                ...
                .andExpect(MockMvcResultMatchers.content().contentType("text/plain;charset=UTF-8"))
                .andExpect(MockMvcResultMatchers.content()
                        .string("Project with code " + request.getCode() + " already exists!"));
    }
}